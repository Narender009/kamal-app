  ...
  return (
    <section className="relative bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-500 text-white overflow-hidden h-140">
      <div className="max-w-6xl mx-auto px-6 py-24 text-center relative z-10">
        ...
        >
          Stay Updated with  <span className="font-semibold text-white">Kamal Legal FinTax Pro Solution</span>
        </motion.p>
        ...
        >
           <span className="text-white font-semibold">Subscribe to our newsletter</span> and <span className="text-white font-semibold">get the latest updates on legal</span>, taxation, business compliance, and government schemes delivered straight to your inbox.
        </motion.p>
      </div>
          ...
          <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
            ...
            <defs>
              <linearGradient id="waveGradient" x1="100%" y1="0%" x2="0%" y2="0%">
                ...
                <stop offset="50%" stopColor="#5b21b6" /> {/* purple-900 */}
