  ...
  return (
    <section className="relative bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-500 text-white overflow-hidden h-140">
      <div className="max-w-6xl mx-auto px-6 py-24 text-center relative z-10">
        ...
        >
          At <span className="font-semibold text-amber-200">Kamal Legal FinTax Pro Solution</span>, we simplify complex legal, taxation, and compliance processes so you can focus on growing your business.
        </motion.p>
        ...
        >
          With a dedicated team of professionals, we offer trusted, end-to-end financial and regulatory services to businesses of all sizes.
        </motion.p>
      </div>
      ...
      <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-0 rotate-180 z-0">
        <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
          ...
          <path d="M321.39,56.44c58-10.79,114.16-30.13,
            ...
            0,0,0,321.39,56.44Z"
            className="fill-blue-900 via-blue-900 to-indigo-900">
          </path>
        </svg>
      </div>
